...
@
<<'haircut_study',eval=INCLUDE_APX_DIST,dependson=c('runtime','consts','haircut_study_setup')>>=
# set everything up
...
manysim <- function(nsamp, genf, nobs=n.obs, nstok=n.stok, zeta=zeta.s, nper=n.per, rseed=1234) {
  ...
  plan(multisession, gc = TRUE, workers = 20)
...
<<'means',eval=INCLUDE_APX_DIST,dependson=c('haircut_study','hcut_qtile'),results='asis'>>=
...
<<'basic_simulations',eval=TRE,dependson=c('runtime','consts','haircut_study_setup')>>=
# set everything up
...
<<'forexample',dependson=c('consts','hcut_qtile')>>=
...
Simple simulations would be revealing.
