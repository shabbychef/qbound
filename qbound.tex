\documentclass{ws-ijtaf}\usepackage[]{graphicx}\usepackage[]{xcolor}
...
\catchline{}{}{}{}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Noise in the Machine:\\ \large Quantifying Overfit of the Markowitz Portfolio}
%\posttitle{\\ \normalsize running title: ``running_title''}
...
We repeat this 1,000 times for each setting of the parameters,
...
\includegraphics[width=0.975\textwidth,height=0.691\textwidth]{figure/qboundmc_basic_plot-1} \caption[Empirical estimates of the expected \txtQual of the \txtMP are plotted.]{Empirical estimates of the expected \txtQual of the \txtMP are plotted versus \psnropt for various values of \nlatf and \ssiz, along with the upper bound of \theoremref{qual_bound}.}\label{fig:mc_basic_plot}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.691\textwidth]{figure/qboundmc_gap_plot_abs-1} \caption[???]{The absolute gap between the bound of \theoremref{qual_bound} and the empirical \txtQual of the \txtMP is plotted for various values of \ssiz, \nfac, \psnropt. }\label{fig:mc_gap_plot_abs}
\end{figure}

\end{knitrout}
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.691\textwidth]{figure/qboundmc_gap_plot_rel-1} \caption[???]{The relative gap between the bound of \theoremref{qual_bound} and the empirical \txtQual of the \txtMP is plotted for various values of \ssiz, \nfac, \psnropt. }\label{fig:mc_gap_plot_rel}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundoverfitting_data-1} \caption[The upper bound of \theoremref{qual_bound} is plotted versus \nlatf for different scaling laws.]{The upper bound of \theoremref{qual_bound} is plotted versus \nlatf for different values of \ssiz, under scaling law $\psnropt = \psnr[0]\nlatf^{\gamma}$, with $\psnr[0]$ fixed and $\gamma=0.18$.}\label{fig:overfitting_data}
\end{figure}
...
$\psnropt = \psnr[0]\nlatf^{\gamma}$ with $\gamma=0.18$ and
$\psnr[0]=1.25\yrtomhalf$.
...
assets, over the 1187 months, is around 
...
$\psnropt=0.84\yrtomhalf$.
The bound on expected value of \pql{\sportwfnc{\mreti}} from \theoremref{qual_bound} is only $0.45\yrtomhalf$.  
If we assume $\psnropt$ is as large as $1\yrtomhalf$, that bound is $0.6\yrtomhalf$.  
...
%were discarded, leaving dim(sub.lr)[2] stocks. 
To check how \psnropt \emph{might} scale with \nlatf, the daily
log returns of the adjusted close prices of the stocks in the 
...
Stocks without a full 16 years of history were discarded, leaving 73 stocks. 
...
%Based on the weekly returns from sp1.TEO.0 to sp1.TEO.f,
Based on the daily returns from 2010-01-04 to 2025-12-31, estimates of \psnropt were computed, using the `KRS' estimator.
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundsp100_grow-1} \caption[Growth of estimated \psnropt versus \nlatf for the NASDAQ 100 Index names, in alphabetical order, showing the `Apple effect.']{Growth of estimated \psnropt versus \nlatf for the NASDAQ 100 Index names, in alphabetical order, showing the `Apple effect.'}\label{fig:sp100_grow}
\end{figure}
...
5,000 times, with the stocks randomly permuted, and 
\psnropt estimated as a function of \nlatf. Boxplots, over the
5,000 simulations, of the KRS statistic versus
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundsp100_box-1} \caption[Growth of estimated \psnropt versus \nlatf for the NASDAQ 100 Index names is shown over 5,000 permutations of the stocks, showing that there is effectively \emph{no} diversification benefit here beyond an equal weight portfolio]{Growth of estimated \psnropt versus \nlatf for the NASDAQ 100 Index names is shown over 5,000 permutations of the stocks, showing that there is effectively \emph{no} diversification benefit here beyond an equal weight portfolio.}\label{fig:sp100_box}
\end{figure}
