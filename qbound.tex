...
Keywords: Sharpe Ratio, Markowitz Portfolio, Portfolio Selection, Quantitative
Finance.\\

Key Messages:
\begin{compactenum}
\item An upper bound on the expected Sharpe ratio of a portfolio is given.
...
\includegraphics[width=0.975\textwidth,height=0.691\textwidth]{figure/qboundhaircutting-1} \caption[Q-Q plot of $10^{6}$ simulated \txtQual values versus \apxref{qual_dist} is shown]{Q-Q plot of $10^{6}$ simulated \txtQual values versus \apxref{qual_dist} is shown.}\label{fig:haircutting}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundksplots-1} \caption[The \txtKS statistic for \apxref{qual_dist} over $10^{6}$ simulations of Gaussian returns is plotted versus $\psnropt \wrapParens{\nlatf-1}/\sqrt{\ssiz}$, with \psnropt in annualized terms, and \ssiz measured in years]{The \txtKS statistic for \apxref{qual_dist} over $10^{6}$ simulations of Gaussian returns is plotted versus $\psnropt \wrapParens{\nlatf-1}/\sqrt{\ssiz}$, with \psnropt in annualized terms, and \ssiz measured in years.}\label{fig:ksplots}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundksheat-1} \caption[The \txtKS statistic for \apxref{qual_dist} over $10^{6}$ simulations of Gaussian returns is indicated, by color, versus \nlatf, and the `total effect size,' $\sqrt{\ssiz}\psnropt$, which is a unitless quantity, with facets for different values of \ssiz (in years)]{The \txtKS statistic for \apxref{qual_dist} over $10^{6}$ simulations of Gaussian returns is indicated, by color, versus \nlatf, and the `total effect size,' $\sqrt{\ssiz}\psnropt$, which is a unitless quantity, with facets for different values of \ssiz (in years).}\label{fig:ksheat}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.99\textwidth,height=0.495\textwidth]{figure/qboundgrow_sqrt-1} \caption[Some quantiles of the \txtQual of the \txtMP, under \apxref{qual_dist}, are plotted versus \nlatf for different scaling laws for \psnropt, with panels for different values of $\gamma$, \viz 0.21, 0.25, and 0.29]{Some quantiles of the \txtQual of the \txtMP, under \apxref{qual_dist}, are plotted versus \nlatf for different scaling laws for \psnropt, with panels for different values of $\gamma$, \viz 0.21, 0.25, and 0.29.}\label{fig:grow_sqrt}
\end{figure}
